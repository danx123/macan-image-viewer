...
class ImageViewer(QMainWindow):
    ...
    def init_ui(self):
        ...
        self._create_tool_bar() # Toolbar atas untuk navigasi & kontrol jendela
        self._create_bottom_bar() # Toolbar bawah untuk aksi edit & view
    ...
    def _create_menu_bar(self):
        """Menyembunyikan Menu Bar karena fungsionalitasnya dipindah ke toolbar bawah."""
        self.menuBar().setVisible(False)

    def _create_bottom_bar(self):
        """Membuat Tool Bar di bagian bawah untuk menampung aksi Edit dan View."""
        bottom_bar = QToolBar("Edit/View Toolbar")
        bottom_bar.setIconSize(QSize(24, 24))
        self.addToolBar(Qt.ToolBarArea.BottomToolBarArea, bottom_bar)

        # Aksi dari menu 'Edit'
        bottom_bar.addAction(self.open_action)
        bottom_bar.addAction(self.save_as_action)
        bottom_bar.addAction(self.copy_action)
        bottom_bar.addAction(self.set_wallpaper_action)
        bottom_bar.addAction(self.open_explorer_action)
        bottom_bar.addAction(self.exit_action)
        bottom_bar.addSeparator()

        # Aksi dari menu 'View'
        bottom_bar.addAction(self.zoom_in_action)
        bottom_bar.addAction(self.zoom_out_action)
        bottom_bar.addAction(self.reset_zoom_action)
        bottom_bar.addSeparator()
        bottom_bar.addAction(self.rotate_left_action)
        bottom_bar.addAction(self.rotate_right_action)
        bottom_bar.addSeparator()
        bottom_bar.addAction(self.flip_horizontal_action)
        bottom_bar.addAction(self.flip_vertical_action)

    def _create_tool_bar(self):
        """Membuat Tool Bar atas."""
    ...
    def _load_current_folder_images(self):
        ...
        # --- FIX DI SINI ---
        # Menggunakan 'is not None' untuk mengevaluasi array NumPy
