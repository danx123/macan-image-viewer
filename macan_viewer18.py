...
from macan_efek import ImageEffects, CollageDialog
...
class ImageViewer(QMainWindow):
    ...
    Resize Dialog, Filmstrip, Save State, Video Playback.
    """
    def __init__(self):
        super().__init__()
    ...
    def show_about_dialog(self):
        ...
        msg_box.setText("<b>Macan Image Viewer v2.7.0</b><br><br>" 
