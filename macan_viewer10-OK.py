...
from PyQt6.QtWidgets import (
    ...
    QFrame, QCheckBox, QLineEdit, QComboBox, QProgressBar
)
from PyQt6.QtGui import QPixmap, QImage, QAction, QIcon, QKeySequence, QPainter, QCursor
from PyQt6.QtCore import (
    Qt, QSize, QPoint, QRect, QByteArray, QThread, QObject, pyqtSignal
)
from PyQt6.QtSvg import QSvgRenderer
from PyQt6.QtPrintSupport import QPrintDialog, QPrinter

# --- [MODIFIKASI] Teks untuk Image Converter Widget ---
CONVERTER_TEXT = {
...
# --- [MODIFIKASI] Kelas Worker untuk Konversi Gambar (diadaptasi dari macan_converter13.py) ---
...
# --- [MODIFIKASI] Widget Baru untuk Image Converter ---
...
class ImageViewer(QMainWindow):
    ...
    def __init__(self):
        ...
        # --- [MODIFIKASI] Variabel untuk window converter ---
    ...
    def init_ui(self):
        ...
        # --- [MODIFIKASI] Menambahkan Drag & Drop dan Icon ---
    ...
    def _create_actions(self):
        ...
        # --- [MODIFIKASI] Aksi untuk Converter ---
    ...
    def _create_tool_bar(self):
        ...
        # --- [MODIFIKASI] Build Converter Menu ---
        ...
        self.tool_bar.addWidget(converter_menu_button) # Added
    ...
    # --- [MODIFIKASI] Fix untuk warna teks di "About" ---
    def show_about_dialog(self):
        msg_box = QMessageBox(self)
        msg_box.setWindowTitle("About Macan Image Viewer")
        msg_box.setTextFormat(Qt.TextFormat.RichText)
        msg_box.setText("<b>Macan Image Viewer v2.0.0</b><br><br>"
    ...
    # --- [MODIFIKASI] Metode baru untuk membuka Converter ---
    ...
    # --- [MODIFIKASI] Event handler untuk Drag & Drop ---
