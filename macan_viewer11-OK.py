...
class ImageViewer(QMainWindow):
    ...
    Window Drag Fix, Rounded Corners, Zoom Slider, Arrow Key Navigation.
    """
    def __init__(self):
        super().__init__()
    ...
    def init_ui(self):
        ...
        # --- MODIFIKASI: Mengubah urutan pemanggilan untuk memperbaiki bug ---
    ...
    def show_about_dialog(self):
        ...
        msg_box.setText("<b>Macan Image Viewer v2.1.0</b><br><br>"
    ...
    def mousePressEvent(self, event):
        if event.button() == Qt.MouseButton.LeftButton:
            ...
            # --- MODIFIKASI: Memperbaiki logika drag window ---
