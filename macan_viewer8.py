...
class ImageViewer(QMainWindow):
    ...
    Perubahan: Undo/Redo, Menu File (Print, Save as PDF, About), semua ikon toolbar diubah ke SVG putih.
    """
    def __init__(self):
        super().__init__()
        ...
        # --- PERUBAHAN BARU: Stack untuk Undo/Redo ---
        self.undo_stack = []
        self.redo_stack = []
    ...
    def init_ui(self):
        ...
        self.setStyleSheet("""
            ...
            /* --- PERUBAHAN BARU: Styling untuk Menu --- */
            QMenu {
    ...
    def _create_actions(self):
        # --- PERUBAHAN BARU: Aksi untuk menu File ---
        ...
        # --- PERUBAHAN BARU: Aksi untuk Undo/Redo ---
    ...
    def _create_tool_bar(self):
        ...
        # --- PERUBAHAN BARU: Mengganti semua ikon dengan SVG putih kustom ---
        icon_color = "#f0f0f0"
        # Navigasi & File
        file_svg = f'<svg viewBox="0 0 24 24"><path fill="{icon_color}" d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zM6 20V4h7v5h5v11H6z"/></svg>'
        ...
        open_svg = f'<svg viewBox="0 0 24 24"><path fill="{icon_color}" d="M19 20H5V8h14v12zM5 6V4h8l2 2H5z" opacity=".3"/><path fill="{icon_color}" d="M20 6h-8l-2-2H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2zm-1 12H5V8h14v10z"/></svg>'
        ...
        # --- PERUBAHAN BARU: Membuat Menu File ---
        ...
        # --- PERUBAHAN BARU: Menambahkan Undo/Redo ke Toolbar ---
        self.tool_bar.addSeparator()
    ...
    def _update_action_states(self, enabled):
        ...
        # --- PERUBAHAN BARU: Mengatur status tombol Undo/Redo ---
    ...
    def open_image(self, file_path=None):
        ...
        if file_path:
            ...
            # --- PERUBAHAN BARU: Reset stack saat buka gambar baru ---
    ...
    # --- PERUBAHAN BARU: Helper untuk Undo Stack ---
    ...
    def show_about_dialog(self):
        QMessageBox.about(self, "About Macan Image Viewer",
                          "<b>Macan Image Viewer</b><br>"
                          "Versi: 7.0<br><br>"
                          "Aplikasi penampil gambar sederhana yang dibuat dengan PyQt6 dan OpenCV.")
    # --- AKHIR FUNGSI BARU ---

    # ... (fungsi mouse events dan resize tidak berubah)
